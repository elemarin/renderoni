...
export const GAMES_METADATA: Record<string, GameMetadata> = {
  alpendrop: {
    ...
    controls: [
      { key: 'Shift / Space', desc: 'Throttle Up (Climb)' },
      { key: 'WASD', desc: 'Pitch / Roll' },
      { key: 'Q / E', desc: 'Yaw Rudder' },
      { key: 'F', desc: 'Magnetic Sling' },
      { key: 'C', desc: 'Camera View' },
      { key: 'H', desc: 'Jobs Board' },
      { key: 'R', desc: 'Reset Aircraft' },
    ],
    quickActions: [
  ...
  quickstart: {
    ...
    controls: [
      ...
      { key: 'Space', desc: 'Jump' },
      { key: 'Shift', desc: 'Sprint' },
      { key: 'E', desc: 'Radial Blast' },
      { key: 'B', desc: 'Spawn Crates' },
      { key: 'N', desc: 'Spawn Spheres' },
    ],
    quickActions: [
